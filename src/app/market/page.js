            ...
            <div className={styles.container}>
                <div className={styles.grid_two_section}>
                    ...
                    <div className={heroStyles.hero_image}>
                        <Image src="/id_sm.png" alt="Fingerprint" width={500} height={500}/>
                    </div>
                </div>
            </div>

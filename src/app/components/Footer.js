                ...
                <div className={footerStyles.content}>
                    <div className={footerStyles.top}>
                        <div className={footerStyles['logo-details']}>
                            <span className={footerStyles.logo_name}>Neurodactyl</span>
                        </div>
                    ...
                    <div className={footerStyles['link-boxes']}>
                        ...
                        <ul className={footerStyles.box}>
                            ...
                            <li><a href="#">Server SDK for fingerprint recognition</a></li>
                            <li><a href="#">Server platform for fingerprint recognition</a></li>
                            <li><a href="#">Mobile SDK for contactless fingerprint capture</a></li>
                        </ul>
                        <ul className={footerStyles.box}>
                ...
                <div className={footerStyles['bottom-details']}>
                    <div className={footerStyles.bottom_text}>
                        <span className={footerStyles.copyright_text}> Copyright © 2023
                            <Link href="/>"> Manish Yadav.</Link> All rights reserved </span>
